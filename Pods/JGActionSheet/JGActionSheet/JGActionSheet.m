...
- (void)setButtonStyle:(JGActionSheetButtonStyle)buttonStyle forButton:(UIButton *)button {
    ...
    if (buttonStyle == JGActionSheetButtonStyleDefault) {
        ...
        titleColor = rgb(237.0f, 105.0f, 0.0f);
    ...
    else if (buttonStyle == JGActionSheetButtonStoStyle) {
        font = [UIFont systemFontOfSize:15.0f];
        titleColor = [UIColor whiteColor];
        
        backgroundColor = rgb(242.0f, 242.0f, 242.0f);
        borderColor = rgb(237.0f, 105.0f, 0.0f);
    }
...
- (void)buttonPressed:(JGButton *)button {
    if (button.tag==101)
    {
        self.buttonPressedBlock([NSIndexPath indexPathForRow:101 inSection:self.tag]);
        return;
    }
